...
#define ulib_openat(dirfd, pathname, flags) ULIB_SYSCALL3(SYS_openat, dirfd, pathname, flags)
#define ulib_close(fd) 						ULIB_SYSCALL1(SYS_close, fd)
#define ulib_read(fd, buf, n) 				ULIB_SYSCALL3(SYS_read, fd, buf, n)
#define ulib_pread(fd, buf, n, offset) 		ULIB_SYSCALL4(SYS_pread, fd, buf, n, offset)
#define ulib_write(fd, buf, n) 				ULIB_SYSCALL3(SYS_write, fd, buf, n)
#define ulib_pwrite(fd, buf, n, offset) 	ULIB_SYSCALL4(SYS_pwrite, fd, buf, n, offset)
